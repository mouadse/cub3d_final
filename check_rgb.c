...
/*   Updated: 2025/06/02 17:23:07 by msennane         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	validate_rgb_characters(char *rgb_color, char *original, char c)
{
	int	rgbCount;
	int	space;
...
void	check_rgb(uint32_t *color, char *rgb_color, char *original, char c)
{
	...
	i = 0;
	validate_rgb_characters(rgb_color, original, c);
